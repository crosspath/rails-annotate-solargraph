    ...
    module Solargraph
      class Rails70Test < ::Minitest::Test
        ...
        def test_generate_rakefile
          ...
          diff = file_diff SCHEMA_RAILS_PATH
          assert_equal SCHEMA_RAILS_PATH, diff.path
          assert_equal 'new', diff.type

          diff = file_diff SOLARGRAPH_FILE_NAME
          assert_equal SOLARGRAPH_FILE_NAME, diff.path
          assert_equal 'new', diff.type
        end
